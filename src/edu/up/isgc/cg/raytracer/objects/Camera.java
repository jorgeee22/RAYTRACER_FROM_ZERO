...
public class Camera extends Object3D {
    ...
    private static final Material DEFAULT_CAMERA_MATERIAL = new Material(
            Color.BLACK,  // Color difuso (irrelevante para cámara)
            Color.BLACK,  // Color especular
            0.0,         // Brillo
            0.0, 0.0,0.0  // Reflectividad
    );

    public Camera(Vector3D position, double fovH, double fovV,
                  int width, int height, double nearPlane, double farPlane) {
        this(position, fovH, fovV, width, height, nearPlane, farPlane, DEFAULT_CAMERA_MATERIAL);
    }
